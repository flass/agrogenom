...
RETURNS bool as '$libdir/ltree' LANGUAGE C IMMUTABLE;

CREATE OR REPLACE FUNCTION ltree_compress(internal)
RETURNS internal as '$libdir/ltree' LANGUAGE C IMMUTABLE;
...
RETURNS int4 as '$libdir/ltree' LANGUAGE C IMMUTABLE;
