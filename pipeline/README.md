...
First, putative paralogous lineages are identified based on species multiplicity in clades, and the corresponding subtrees are extracted from the full gene tree. (cf. [subsection I.2](https://github.com/flass/agrogenom/tree/master/pipeline#2-find-putative-duplications-and-extract-unicopy-subtrees))
...
Histories of all lineages are then mapped back to the full gene family tree and integrated as one gene family scenario. (cf. [subsection I.4](https://github.com/flass/agrogenom/tree/master/pipeline#4-integration-of-reconciliation-scenarios))
