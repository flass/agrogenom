...
```
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4907066.v4).
...
When the support for the node is below a threshold (in this exemple 0.9) and the number of losses implied by this duplication (and the leaf set below the node) is higher than a threshold (here 0.2, in number of implied loss per branches in the subtree), an attempt to modify the local tree topology is made. 
...
Find example results for Agrogenom study and detail of output files on [Figshare](https://doi.org/10.6084/m9.figshare.4907066.v4).
...
```
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4910177.v1).
...
```
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4910210.v1).
...
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4910576.v1).
...
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4910699.v2).
...
EOF
```
Find example results for Agrogenom study on [Figshare](https://doi.org/10.6084/m9.figshare.4910702.v1).
