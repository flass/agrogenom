...
The procedure is the same than for [HOGENOM databases], which is described in the [Penel et al. 2009] paper and with updated details [here](http://doua.prabi.fr/databases/hogenom/home.php?contents=methods).
